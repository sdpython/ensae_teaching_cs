...
def optimisation():
    ...
    Traceback (most recent call last):
      File "toutbiss.py", line 236, in <module>
        liste_composition,liquide = actualisation(liste_df,index,liquide,liste_composition,nb_jours_rendement,nb_jours_volatilite,volatilite_max) #on actualise le portefeuille (-> Actualisation)
      ...
      File "C:\Python34\lib\site-packages\cvxopt\coneprog.py", line 1852, in coneqp
    ...
    @code
    Traceback (most recent call last):
      File "C:\Python34\lib\site-packages\cvxopt\coneprog.py", line 2271, in coneqp
        try: f3 = kktsolver(W)
    ...
    Traceback (most recent call last):
      ...
      File "toutbiss.py", line 122, in volatilite_quadra2
        sol=solvers.coneqp(P=P,q=q,G=G,h=h,b=b,A=A)
      File "C:\Python34\lib\site-packages\cvxopt\coneprog.py", line 2274, in coneqp
