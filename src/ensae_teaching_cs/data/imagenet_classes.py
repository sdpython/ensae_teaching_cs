"""
@file
@brief Deals with :epkg:`ImageNet` classes.
"""
...
def interpret_imagenet_results(probas, n=10):
    """
    Interprets results if image net.

    :param probas: array of 1000 probabilities
    :param n: number of top probabilities to keep
    """
    ar = numpy.argpartition(-probas, n)[:n]
    subset = [(probas[a], a) for a in ar]
    subset.sort(reverse=True)
    return OrderedDict((_class_names[i], p) for p, i in subset)
