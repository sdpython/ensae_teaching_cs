...
'''
@file 
@brief Goslate: Free Google Translate API.
This file was taken from the package 
`goslate <https://bitbucket.org/zhuoqiang/goslate/src>`_
but it uses the package `futures <https://pypi.python.org/pypi/futures>`_
which I prefer to avoid downloading.
'''
