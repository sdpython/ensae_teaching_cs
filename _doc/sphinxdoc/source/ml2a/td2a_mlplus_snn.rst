...
Les réseaux de neurones *spiking* ajoutent un nouveau
degré de liberté qui est celui de propager le signal
ou non.
...
* `SNN toolbox <http://snntoolbox.readthedocs.io/en/latest/guide/intro.html>`_

*Github*

* `Spiking-Neural-Network <https://github.com/Shikhargupta/Spiking-Neural-Network>`_
